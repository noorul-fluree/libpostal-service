...
public:
    METHOD_LIST_BEGIN
    ADD_METHOD_TO(ParseController::parse, "/api/v1/parse", drogon::Post, "addr::AuthFilter");
    ADD_METHOD_TO(ParseController::normalize, "/api/v1/normalize", drogon::Post, "addr::AuthFilter");
    METHOD_LIST_END
