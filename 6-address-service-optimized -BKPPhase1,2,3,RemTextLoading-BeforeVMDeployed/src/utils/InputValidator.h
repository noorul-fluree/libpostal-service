...
public:
    ...
    // static constexpr size_t MAX_BODY_SIZE = 12 * 1024 * 1024; // 12 MB
    // static constexpr size_t MAX_BODY_SIZE = 50 * 1024 * 1024; // 50 MB
    /// not used anywhere that's y commented. It handled in main.cc for 256 mb
    ...
    static ValidationResult validateBatch(const Json::Value& json, int max_batch_size) {
        ...
        // Over-limit batches are sliced by the controller — not rejected here
